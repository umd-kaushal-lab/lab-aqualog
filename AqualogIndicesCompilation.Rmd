...
#Need to pull out the blanks and calculate the Raman area - we also have this from the run log? not sure of the best approach here...
#pull in the Raman files
...
#Calculate raman area same as staRdom
#then divide our values by that number

eem_list <- eem_raman_normalisation(eem_list, eem_blank)
